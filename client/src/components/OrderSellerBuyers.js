...
const OrdersSellerBuyers = (props) => {
  ...
  if (deleteOrderPopUp) {
    ...
    return (
      ...
      >
        Oletko varma että haluat poistaa tilauksen tilaajalta{" "}
        {props.Order[productIndexi].users_firstname}
        {props.Order[productIndexi].users_lastname}
      </OrderDeletePopUp>
    )
  }
  ...
  if (deleteProductPopUp) {
    return (
      ...
      >
        Oletko varma että haluat poistaa tilaajalta{" "}
        {props.Order[productIndexi].users_firstname}{" "}
        {props.Order[productIndexi].users_lastname} tuotteen {productName}
      </OrderDeletePopUp>
    )
  }
          ...
          <Accordion.Toggle as={Button} variant="text" eventKey="0">
            <Row className="flex-nowrap align-items-center">
              ...
              >
                ...
                <Card.Text>{buyer.order_id}</Card.Text>
              </Col>
              <Col xs={3}>
                <Button
                  type="button"
                  ...
                  onClick={() => setOrderId(buyer.order_id)}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
