...
const ProductSchema = yup.object().shape({
  ...
  sizes: yup.array().of(yup.number().positive("Koko ei voi olla negatiivinen")),
  quantities: yup.array().of(yup.number().moreThan(1, "Määrä ei voi olla negatiivinen")),
})
          ...
          <Form onSubmit={handleSubmit} className="mx-3">
            ...
            <Form.Row>
              <Col className="mb-3 text-center">
                {eventChoiceError && (
                  <p className="mb-3 text-danger">Valitse myyntipiste(et) ensin.</p>
                )}
                {(errors.category ||
                  errors.title ||
                  errors.description ||
                  ...
                  errors.sizes ||
                  errors.quantities) && (
                  <p className="text-danger">Puuttuvaa tietoa. Tarkista lomake.</p>
                )}
