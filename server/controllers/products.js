...
productsRouter.post('/:id', async (req, res) => {
  const { id } = req.params
  const dbParams = [req.body.title, req.body.organic, req.body.sellers_id, req.body.type, req.body.batch_quantity, req.body.description, req.body.imageURL, req.body.category]
